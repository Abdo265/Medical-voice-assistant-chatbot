...
SYSTEM_PROMPT = (
    ...
    "2. اذكر أسماء أدوية تجارية مصرية معروفة زي بانادول أو برونيفين أو غيرها يعني لو شخص سال عن هل عندك دواء لعلاج الفصام والاضطراب ثنائي القطب ممكن تجاوب ب Abilify وتكتب اسمه بالانجليزي.\n"
